...
import PSD_random_signal_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
...
class PSD_random_signal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSD_random_signal")
        ...
        self.qtgui_vector_sink_f_0.set_y_axis_units("W/Hz")
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, 128000,True)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_float*1, N)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_float*1)
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_vff(N*[1/(N*samp_rate)])
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(2)
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_char*1, '/home/labcom/Documentos/campoç/lab 3/Archivos a usar/Rojo.jpg', True, 0, 0)
        self.blocks_file_source_1.set_begin_tag(pmt.PMT_NIL)
        self.blocks_complex_to_mag_squared_1 = blocks.complex_to_mag_squared(1024)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 1, 76)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, -500e-3)
        ...
        self.connect((self.blocks_complex_to_mag_squared_1, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_file_source_1, 0), (self.blocks_unpack_k_bits_bb_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self.qtgui_vector_sink_f_0, 0))
        ...
        self.connect((self.epy_block_0, 0), (self.blocks_multiply_const_vxx_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_multiply_const_vxx_2.set_k(self.N*[1/(self.N*self.samp_rate)])
...
def main(top_block_cls=PSD_random_signal, options=None):
